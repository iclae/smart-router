...
The SKILL.md §7 check that catches a **falsifiable spawn prediction** proven wrong — the main having reached back into a process it spawned away — and records it to #13 at the moment of detection. Measurement only, no routing change; catches in-session falsifications only. The minimal layer 2 of #13's loop; derivation in ADR-0017.
